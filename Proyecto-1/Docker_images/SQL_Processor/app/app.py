...
# señalar en los app.py los que ocupan hacer los replace y verifica que sea un replace y no un dato (%{ }%)   (variables de la expresion y dest_queue de transformation)
...
def callback(ch, method, properties, body):
    ...
    print(doc)
    channel.basic_publish(exchange = '', routing_key = REGEX_QUEUE, body = json.dumps(doc))
